...
trait AuthenticatesUsers
{
    ...
    public function login(Request $request)
    {
        ...
        //$2y$10$9fVfamh3kUieLfD.cuOHy.ouJ.FH11Wdy8Khec6JHntobU0ikCbyW
        ...
        //dd('encryptString : ', $password, 'decryptString : ', Crypt::decryptString($password));
        $ldaprdn = 'cnps' . "\\" . Crypt::decryptString($username);
        ...
        if ($ldap) {
            ...
            try {
                ...
                if ($ldapbind) {
                    ...
                    $mle = str_replace('m','',Crypt::decryptString($username));
