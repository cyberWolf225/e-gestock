        ...
        @if(isset($demande_cotation))
            ...
            @foreach($detail_demande_cotations as $detail_demande_cotation)
                ...
                <?php
                    ...
                    $reponse_data = $controller1->procedureSetDetailReponseCotationFormat($detail_demande_cotation->detail_demande_cotations_id,$reponse_cotation->id,$mieux_disant->id);
                    
                ?>
                <tr>
                    <td style="border-collapse: collapse; padding: 0; margin: 0;">

                        <input required style="background-color: transparent; border: none; display:none" onfocus="this.blur()" id="detail_mieux_disants_id" name="detail_mieux_disants_id[]" class="form-control detail_mieux_disants_id" value="{{ $reponse_data['detail_mieux_disants_id'] ?? '' }}"/>
                    ...
                    @if($griser_selection === null)
                        <td style="vertical-align: middle; text-align:center; border-collapse: collapse; padding: 0; margin: 0;">
                            <a onclick="removeRowBcn(this)"  class="remove" title="Retirer cet article">
