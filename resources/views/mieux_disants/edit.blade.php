        ...
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form enctype="multipart/form-data" method="POST" action="{{ route('mieux_disants.update') }}">
                        @csrf
                                ...
                                <div class="row d-flex" style="margin-top: -10px;">
                                    ...
                                    <div class="col-md-3 pr-1">
                                        <div class="form-group d-flex ">
                                            ...
                                            <input onfocus="this.blur()" name="mieux_disants_id" id="mieux_disants_id" style="display:none" value="{{ $mieux_disant->id ?? '' }}">
                            ...
                            <div class="panel panel-footer">
                                @if(isset($demande_cotation->libelle))
                                    ...
                                    <div id="div_detail_bcs" style="@if($display_div_detail_bcs === null) display:none @endif">
                                        @include('mieux_disants.partial_edit_bcs')
                                    </div>
                                ...
                                @if(isset($demande_cotation->libelle))
                                    ...
                                    <div id="div_detail_bcn" style="@if($display_div_detail_bcn === null) display:none @endif">
                                        @include('mieux_disants.partial_edit_bcn')
                                    </div>
                                ...
                                @include('mieux_disants.partial_edit_footer')
                                    ...
                                    <table style="width: 100%">
                                        <tr>
                                            <td colspan="4" style="border-bottom: none">
                                                <span style="font-weight: bold">Dernier commentaire écrit par </span> <span style="color: brown; margin-left:3px;"> {{ $statut_mieux_disant->nom_prenoms ?? '' }} </span>&nbsp; (<span style="font-style: italic; color:grey"> {{ $statut_mieux_disant->name ?? '' }} </span>)
                                                ...
                                                <table width="100%" cellspacing="0" border="1" style="background-color:#d4edda; border-color:#155724; font-weight:bold">
                                                    <tr>
                                                        <td>
                                                            ...
                                                            </svg> &nbsp; {{ $statut_mieux_disant->commentaire ?? '' }}
                                                        </td>
                                                    </tr>
                                                </table>
                                            </td>
