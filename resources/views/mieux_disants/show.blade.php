...
<div class="container" style="color:black">
    ...
    <div class="row"> 
        <div class="col-md-12">
            ...
            <div class="card">
                <div class="card-header entete-table">{{ mb_strtoupper( $buttons['titre'] ?? 'Aperçu DU MIEUX DISANT') }} 
                        ...
                        <div class="panel panel-footer">
                            @if(isset($demande_cotation->libelle))
                                ...
                                <div id="div_detail_bcs" style="@if($display_div_detail_bcs === null) display:none @endif">
                                    @include('mieux_disants.partial_show_bcs')
                                </div>
                            ...
                            @if(isset($demande_cotation->libelle))
                                ...
                                <div id="div_detail_bcn" style="@if($display_div_detail_bcn === null) display:none @endif">
                                    @include('mieux_disants.partial_show_bcn')
                                </div>
                            ...
                            @include('mieux_disants.partial_show_footer')
