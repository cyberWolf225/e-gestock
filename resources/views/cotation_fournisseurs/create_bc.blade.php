            ...
            <div class="card">
                ...
                <?php
                    ...
                    if (isset($credit_budgetaires_credit)) {
                        ...
                        $credit = $credit_budgetaires_credit;
                    ...
                    if(isset($demande_achat_info->net_a_payer)){
                        ...
                        if (isset($credit_budgetaires_credit)) {
                            if ($credit_budgetaires_credit >= $net_a_payer) {
                ...
                <div class="card-body">
                    ...
                    @endif
                    <form method="POST" action="{{ route('cotation_fournisseurs.store_bc') }}">
                        @csrf
                        <div class="row d-flex">
                            <div class="col-md-6">
                                <div class="row d-flex" style="margin-top: -10px;">
                                    ...
                                    <div class="col-md-3 pr-1">
                                        <div class="form-group d-flex ">
                                            <input onfocus="this.blur()" style="color:red; font-weight:bold; margin-top:-6px;" autocomplete="off" type="text" name="num_bc" class="form-control griser" value="{{ $num_bc ?? '' }}">
                                        ...
                                        <div class="col-sm-3">
                                            <div class="form-group" style="text-align: right">
                                                ...
                                                <label class="label" class="mt-1 ">Signataire <!--<sup style="color: red">*</sup>
                                                    ...
                                                    <br/>
                                                    <a title="Ajouter un signataire" onclick="myCreateFunction()" class="addRow" style="cursor:pointer">
                                                    ...
                                                    @if(count($signataires) > 0)
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                ...
                                                                style="background-color: #e9ecef"
                                                                autocomplete="off" type="text" name="nom_prenoms[]" class="form-control griser nom_prenoms" 
                                                                required
                                ...
                                <div class="row d-flex" style="margin-top: -10px;">
                                    ...
                                    <label class="label" @if(isset($credit_budgetaires_credit)) @if($credit_budgetaires_credit > 0) style="color:green" @else style="color:red" @endif @else style="color:red" @endif >Solde disponible avant opération : </label></div>

                                    <input required type="text" name="solde_avant_op"  value="{{ $credit_budgetaires_credit ?? '' }}" class="form-control-sm" style="display:none" onfocus="this.blur()"/>

                                    <div class="col-sm-3"><label class="label" @if(isset($credit_budgetaires_credit)) @if($credit_budgetaires_credit > 0) style="color:green" @else style="color:red" @endif @else style="color:red" @endif >@if(isset($credit_budgetaires_credit)) {{ strrev(wordwrap(strrev($credit_budgetaires_credit ?? 'aucun budget'), 3, ' ', true)) ?? '' }} @else <svg style="color:red" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-emoji-frown" viewBox="0 0 16 16">
                                ...
                                @if(isset($profil_fournisseur))
                                    @if($profil_fournisseur != null)
                                        ...
                                        <div class="row d-flex" style="margin-top: -10px;">
                                            <div class="col-sm-3">
                                                <div class="form-group" style="text-align: right">
                                                    <label class="label" class="mt-1 ">Date livraison<span style="color:red"><sup> *</sup></span> </label> 
                                                </div>
                                            </div>
                                            <div class="col-md-6 pr-1">
                                                <div class="form-group">
                                                    <input autocomplete="off" type="date" name="date_livraison_prevue" class="form-control @error('date_livraison_prevue') is-invalid @enderror" @if(isset($demande_achat_info->date_livraison_prevue))
                            ...
                            <table class="table table-bordered table-striped" id="myTable" style="width:100%">
                                <thead>
                                    <tr style=" background-color:#aabcc6; text-align: center; color:#033d88; text-shadow: 2px 5px 5px white ;">
                                        ...
                                        <th style="width:60%; text-align:center">DÉSIGNATION ARTICLE</th>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td style="width:1px; white-space:nowrap;text-align:left; vertical-align:middle; font-weight:bold; color: #7d7e8f">
                                            <input onfocus="this.blur()" style="background-color: #e9ecef; display:none;  font-weight:bold; text-align:center" value="{{ $demande_achat->ref_articles ?? '' }}" autocomplete="off" required list="list_article" type="text" onkeyup="editDesign(this)" id="ref_articles" name="ref_articles[]" class="form-control ref_articles">
                                        ...
                                        <td style="width:1px; white-space:nowrap;text-align:right; vertical-align:middle">
                                            ...
                                            autocomplete="off" required type="text" onkeyup="editMontant(this)" name="prix_unit[]" class="form-control prix_unit">
                                        ...
                                        <td style="width:1px; white-space:nowrap;text-align:center; vertical-align:middle">
                                            ...
                                            autocomplete="off" type="text" onkeyup="editMontant(this)" name="remise[]" class="form-control remise">
                                        ...
                                        <td style="width:1px; white-space:nowrap;text-align:right; vertical-align:middle">
                                            ...
                                            autocomplete="off" required onfocus="this.blur()" style="background-color: #e9ecef;text-align:right; display:none" type="text" name="montant_ht[]" class="form-control montant_ht">
                                        ...
                                        <td style="text-align: center; vertical-align:middle;">
                                            ...
                                            @if(isset($echantillon))
                                                ...
                                                <!-- Modal --> 
                                                    ...
                                                    <a href="#" data-toggle="modal" data-target="#exampleModalCenter{{ $demande_achat->id }}">
                                    ...
                                    <tr>
                                        <td colspan="8" style="border: none">
                                            <div class="row d-flex pl-3">
                                                    ...
                                                    @endif required autocomplete="off" onfocus="this.blur()" style="background-color: #e9ecef; width:110px;text-align:right" type="text" name="montant_total_brut" class="form-control montant_total_brut"></div>
                                                    ...
                                                    <div class="pl-1"><label class="label" class=" mt-1 mr-2">Remise</label><br>  <input onfocus="this.blur()" 
                                                        ...
                                                        onkeyup="editRemiseGenerale(this)" autocomplete="off"  style="width:110px; background-color: #e9ecef;text-align:right" type="text" name="remise_generale" class="form-control remise_generale"></div>
                                            ...
                                            <div class="row d-flex pl-3">
                                                ...
                                                <div class="pr-0"><label class="label" class=" mt-1 mr-2">Assiette BNC</label><br>  <input value="{{ $demande_achat->assiete_bnc }}" autocomplete="off" onfocus="this.blur()" style="background-color: #e9ecef; width:110px;text-align:right" type="text" name="assiette" class="form-control assiette"></div>
                                                ...
                                                id="acompte_taux_div" ><label class="label" class=" mt-1 mr-2">(%)</label><br>  <input onfocus="this.blur()" onkeyup="editRemiseGenerale(this)" @if(isset($demande_achat->taux_acompte)) value="{{ number_format($demande_achat->taux_acompte ?? '',2) }}" @endif autocomplete="off" onkeypress="validate(event)" style=" width:70px; text-align:center; background-color: #e9ecef;" type="text" name="taux_acompte" class="form-control taux_acompte"></div>
                                                ...
                                                autocomplete="off" onfocus="this.blur()" oninput="validateNumber(this);" style=" width:110px; text-align:right; background-color: #e9ecef;" type="text" name="montant_acompte" class="form-control montant_acompte"></div>
                                        ...
                                        @if(count($piece_jointes)>0)
                                            @foreach($piece_jointes as $piece_jointe)
                                                <tr>
                                                    ...
                                                    <td style="border: none;vertical-align: middle; text-align:right; font-weight:bold">
                                    ...
                                    <td colspan="3" style="border: none; vertical-align:middle; text-align:right">
                                        ...
                                        <div class="row justify-content-center">
                                            ...
                                            <div class="col-md-3" style="margin-top:0px"> 
                                                ...
                                                @if(isset($value_button2))
                                                    <button  onclick="return confirm('Êtes-vous sûr de rejeter cette demande d\'achat ?')" style="margin-left:10px; width:100px;" type="submit" name="submit" value="{{ $value_button2 }}" class="btn btn-danger">{{ $button2 }}</button>
                                                @endif

                                                @if(isset($value_button))
                                                    <button  onclick="return confirm('Êtes-vous sûr d\'effectuer cette opération ?' )" style="margin-left:10px; width:100px;" type="submit" name="submit" value="{{ $value_button }}" class="btn btn-success">{{ $button }}</button>
                                                @endif
...
<script>
    ...
    function myCreateFunction() {
        ...
        if(nbre_rows < 2){
            ...
            cell2.innerHTML = '<td> <input onfocus="this.blur()" style="font-weight: normal;color:gray;font-size: 10px;background-color: #e9ecef;border-color:transparent;" autocomplete="off" type="text" name="nom_prenoms[]" class="form-control nom_prenoms"></td>';
