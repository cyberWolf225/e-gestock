...
<body>
            ...
            <td>
                <table style="margin-top: 0px;">
                    <tr>
                        ...
                        <td>
                            <strong>N° {{ $travauxe->num_bc ?? '' }}</strong>
                        </td>
                    </tr>
                </table>
                ...
                <table width="100%">
                    <tr>
                        ...
                        <td style="margin-top:5px;">
                            <strong>{{ $travauxe->exercice ?? '' }}</strong> 
                        </td>
                        <td style="margin-top:5px;">
                        ...
                        <td style="margin-top:5px;">
                            <strong>
                                @if(isset($travauxe->created_at))
                                    {{ date('d/m/Y',strtotime($travauxe->created_at)) }}
                                @endif
                            </strong> 
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td style="margin-top:5px;">
                            <strong>{{ $travauxe->ref_fam ?? '' }}</strong> 
                        </td>
                        <td style="margin-top:5px;">
                            DATE DE RETRAIT 
                        </td>
                        <td style="margin-top:5px;">
                            <strong>
                                @if(isset($travauxe->date_retrait))
                                    {{ date('d/m/Y',strtotime($travauxe->date_retrait)) }}
                                @endif
                            </strong>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td style="margin-top:5px;">
                            <strong>{{ $travauxe->code_structure ?? '' }}</strong> 
                        </td>
                    </tr>
                    <tr>
                        <td style="margin-top:5px;">
                        ...
                        <td style="margin-top:5px;">
                            <strong>{{ $travauxe->code_gestion ?? '' }} {{ $travauxe->libelle_gestion ?? '' }}</strong> 
                        </td>
                        <td style="margin-top:5px;">
                            FOURNISSEUR
                        </td>
                        <td style="margin-top:5px;">
                            <strong>{{ $travauxe->denomination ?? '' }}</strong> 
                        </td>
                    </tr>
                    <tr>
                        <td style="margin-top:5px;">
                        ...
                        <td style="margin-top:5px;">
                            <strong>{{ $travauxe->entnum ?? '' }}</strong> 
                        </td>
                        <td style="margin-top:5px;">
                            COMPTE CONTRIBUABLE
                        </td>
                        <td style="margin-top:5px;">
                            <strong>{{ $travauxe->num_contribuable ?? '' }}</strong> 
                        </td>
                    </tr>
                    <tr>
                        <td style="margin-top:5px;">
                        ...
                        <td style="margin-top:5px;">
                            <strong>{{ $travauxe->adresse ?? '' }}</strong> 
                        </td>
                        <td style="margin-top:5px;">
                            TELEPHONE
                        </td>
                        <td style="margin-top:5px;">
                            <strong>{{ $travauxe->contacts ?? '' }}</strong> 
                        </td>
                    </tr>
                </table>
                ...
                <table width="100%" style="margin-top: 20px;">
                    <tr>
                        <td>
                            {{ mb_strtoupper($travauxe->intitule ?? '') }}
                        </td>
                    </tr>
                </table>
                
                <table cellspacing="0" width="100%; margin:auto" border="1" style="margin-top: 20px;">
                    <thead>
                        <tr>
                        <td class="tr" style="text-align: center">DÉSIGNATION</td>
                    ...
                    <tbody>
                        ...
                        @foreach($detail_travauxes as $detail_travauxe)
                            ...
                            <?php 
                                ...
                                if (isset($detail_travauxe->code_unite)) {
                                    $unite = DB::table('unites')->where('code_unite',$detail_travauxe->code_unite)->first();
                                    if ($unite!=null) {
                                ...
                                // affichage decimal
                                    $detail_travauxe->prix_unit = number_format((float)$detail_travauxe->prix_unit, 2, '.', '');
                                    $block_prix_unit = explode(".",$detail_travauxe->prix_unit);
                                    ...
                                    $detail_travauxe->remise = number_format((float)$detail_travauxe->remise, 2, '.', '');
                                    $block_remise = explode(".",$detail_travauxe->remise);
                                    ...
                                    $detail_travauxe->montant_ht = number_format((float)$detail_travauxe->montant_ht, 2, '.', '');
                                    
                                    $block_montant_ht = explode(".",$detail_travauxe->montant_ht);
                            ...
                            ?>
                            <tr>
                                <td class="td-left">{{ $detail_travauxe->libelle ?? '' }}</td>
                                <td class="td-center">{{ strrev(wordwrap(strrev($detail_travauxe->qte ?? ''), 3, ' ', true)) }}</td>
                                <td class="td-right">
    ...
    <?php
        ...
        $travauxe->montant_total_brut = number_format((float)$travauxe->montant_total_brut, 2, '.', '');
        $block_montant_total_brut = explode(".",$travauxe->montant_total_brut);
        ...
        $travauxe->remise_generale = number_format((float)$travauxe->remise_generale, 2, '.', '');
        $block_remise_generale = explode(".",$travauxe->remise_generale);
        ...
        $travauxe->montant_total_net = number_format((float)$travauxe->montant_total_net, 2, '.', '');
        $block_montant_total_net = explode(".",$travauxe->montant_total_net);
        ...
        $travauxe->montant_total_ttc = number_format((float)$travauxe->montant_total_ttc, 2, '.', '');
        $block_montant_total_ttc = explode(".",$travauxe->montant_total_ttc);
        ...
        $travauxe->montant_acompte = number_format((float)$travauxe->montant_acompte, 2, '.', '');
        $block_montant_acompte = explode(".",$travauxe->montant_acompte);
        ...
        $travauxe->tva = number_format((float)$travauxe->tva, 2, '.', '');
        $block_tva = explode(".",$travauxe->tva);
    ...
    <table width="99%" style="width: 99%; margin:auto; margin-top:-3px; font-size: 11px;" cellspacing="0" border="1">
        <tr>
                        ...
                        <td style="border:0px; border-color:transparent; border:none">
                            <table cellspacing="0" width="100%" style="width: 100% ; border:0px; border-color:transparent; border:none">
                                ...
                                <tr>
                                    ...
                                    <td class="td-center td-border-none">
                                        ...
                                        @if(isset($tva_partie_decimale) && $tva_partie_decimale != 0)
                                            {{ strrev(wordwrap(strrev($tva_partie_entiere ?? ''), 3, ' ', true)).'.'.strrev(wordwrap(strrev($tva_partie_decimale ?? ''), 3, ' ', true)) }}
                                            @else
                                            {{ strrev(wordwrap(strrev($tva_partie_entiere ?? ''), 3, ' ', true)) }}
                                        @endif
                                    ...
                                    <?php
                                        ...
                                        if (isset($travauxe->tva)) {
            
                                            $montant_tva = ($travauxe->montant_total_net/100)* $travauxe->tva;
                                ...
                                <tr>
                                    ...
                                    <td class="td-center td-border-none">
                                        @if(isset($travauxe->taux_acompte))
                                            {{ number_format($travauxe->taux_acompte,2) }}%
                                        @endif
                                        </td>
                                    <td class="td-right td-border-none">
                                ...
                                <tr>
                                    ...
                                    <?php
                                        ...
                                        if (isset($travauxe->montant_acompte)) {
            
                                            $montant_reste_a_payer = ($travauxe->montant_total_ttc - $travauxe->montant_acompte);
                                            
                                        }else{
                                            $montant_reste_a_payer = $travauxe->montant_total_ttc;
                                        }
    ...
    <table width="99%" style="width: 99%; margin:auto; margin-top:3px; font-size: 11px;" border="1" cellspacing="0">
        <tr>
            <td style="padding:10px">
                ...
                @if(isset($montant_total_ttc_partie_entiere))
                    ...
                    {{ mb_strtoupper(str_replace('euro', 'euros', str_replace('Franc', 'Francs', $travauxe->devises_libelle ?? ''))) }}
                @endif
