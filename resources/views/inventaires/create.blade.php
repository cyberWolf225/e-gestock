...
<div class="container"> 
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                <div class="card-header entete-table">{{ __('INVENTAIRE') }} 
                ...
                <div class="card-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group ml-0">
                                            <input autocomplete="off" type="date" name="debut_per" class="form-control @error('debut_per') is-invalid @enderror" value="{{ old('debut_per') }}"  autocomplete="debut_per">
                                        </div>
                                        @error('debut_per')
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <input autocomplete="off" type="date" name="fin_per" class="form-control @error('fin_per') is-invalid @enderror" value="{{ old('fin_per') }}"  autocomplete="fin_per">
                                        </div>
                                        @error('fin_per')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            <button type="submit" class="btn btn-primary">Initier la période</button>
                                        </div>
                                    </div>
                                </div>
                            </form>
                    ...
                    @endif
                    <table id="example1" class="table table-striped table-bordered bg-white" width="100%">
                        <thead>
                          <tr id="">
                            ...
                            <th class="td-center-white-space" style="vertical-align: middle">&nbsp;</th>
                          </tr>
                        </thead>
                        <tbody> 
                            @foreach($inventaires as $inventaire)
                                <?php 
                                    ...
                                    $inventair = DB::table('inventaires as i')
                                    ...
                                    if ($type_profils_name === 'Gestionnaire des stocks' or $type_profils_name === 'Responsable des stocks') { 
                                        ...
                                        if ($inventair === null) {
                                            ...
                                            $href_show = "/inventaire_articles/index/".$inventaires_id;
                                            $display_show = "";
                                    ...
                                    }elseif ($type_profils_name === 'Responsable des achats' or $type_profils_name === 'Administrateur fonctionnel' or $type_profils_name === 'Responsable DMP') {
                                    ...
                                    if (isset($inventaire->debut_per)) {
                                        $debut_per = date('d/m/Y',strtotime($inventaire->debut_per));
                                    }

                                    $fin_per = null;
                
                                    if (isset($inventaire->fin_per)) {
                                        $fin_per = date('d/m/Y',strtotime($inventaire->fin_per));
                                    }
                                ...
                                <tr>
                                    <td class="td-center-white-space" style="vertical-align:middle; border-collapse: collapse; padding: 0; margin: 0;">{{ $inventaire->id ?? '' }}</td>    
                                    <td style="text-align:center; vertical-align:middle; border-collapse: collapse; padding: 0; margin: 0;">{{ $debut_per ?? '' }}</td>    
                                    <td style="text-align:center; vertical-align:middle; border-collapse: collapse; padding: 0; margin: 0;">{{ $fin_per ?? '' }}</td>    
                                    <td style="text-align:center; vertical-align:middle; border-collapse: collapse; padding: 0; margin: 0;">{{ $flag_valide ?? '' }}</td>    
                                    <td style="text-align:center; vertical-align:middle; border-collapse: collapse; padding: 0; margin: 0;">{{ $flag_integre ?? '' }}</td>    
                                    <td class="td-center-white-space" style="border-collapse: collapse; padding: 0; margin: 0;">
