...
<div class="container">
    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
          ...
          @endif
            <div class="card">
                <div class="card-header entete-table">{{ __('Modification de données de magasin') }}</div>

                <div class="card-body">
                    <form method="POST" action="{{ route('magasins.update') }}">
                        @csrf
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="form-group row">  
                                        ...
                                        <div class="col-md-2">
                                            ...
                                            <input style="background-color: #e9ecef;" onfocus="this.blur()" onkeyup="editMagasin(this)" id="ref_magasin" type="text" class="form-control @error('ref_magasin') is-invalid @enderror" name="ref_magasin" value="{{ old('ref_magasin') ?? $search_magasin->ref_magasin ?? '' }}">

                                            <input style="background-color: #e9ecef;display: none" onfocus="this.blur()" list="id" id="id" type="text" class="form-control @error('id') is-invalid @enderror" name="id" value="{{ old('id') ?? $search_magasin->id ?? '' }}">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <input id="design_magasin" type="text" class="form-control @error('design_magasin') is-invalid @enderror" name="design_magasin" value="{{ old('design_magasin') ?? $search_magasin->design_magasin ?? '' }}">
                                    ...
                                    <div class="form-group row">  
                                        ...
                                        <div class="col-md-2">
                                            ...
                                            <input onkeyup="editDepot(this)" list="ref_depot" id="ref_depot" type="text" class="form-control @error('ref_depot') is-invalid @enderror" name="ref_depot" value="{{ old('ref_depot') ?? $search_magasin->ref_depot ?? '' }}">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <input style="background-color: #e9ecef" onfocus="this.blur()" id="design_dep" type="text" class="form-control @error('design_dep') is-invalid @enderror" name="design_dep" value="{{ old('design_dep') ?? $search_magasin->design_dep ?? '' }}">
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            <br>
                                            <span>
                                                <label style="margin-top: 10px">Non</label>  <input disabled id="principal0" type="radio" name="principal" value="0" style="margin-left: 10px" 
                                                @if(isset($search_magasin->principal))
                                                    @if($search_magasin->principal == 0)
                                                        checked
                                                    @endif
                                                @endif 
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            <input style="background-color: #e9ecef" onfocus="this.blur()" id="tel_dep" type="text" class="form-control @error('tel_dep') is-invalid @enderror" name="tel_dep" value="{{ old('tel_dep') ?? $search_magasin->tel_dep ?? '' }}">
                                    ...
                                    <div class="form-group row">
                                        <div class="col-md-4">
                                            ...
                                            <input style="background-color: #e9ecef" onfocus="this.blur()" id="adr_dep" type="text" class="form-control @error('adr_dep') is-invalid @enderror" name="adr_dep" value="{{ old('adr_dep') ?? $search_magasin->adr_dep ?? '' }}">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <input style="background-color: #e9ecef" onfocus="this.blur()" id="ville_dep" type="text" class="form-control @error('ville_dep') is-invalid @enderror" name="ville_dep" value="{{ old('ville_dep') ?? $search_magasin->nom_ville ?? '' }}">
                                        ...
                                        <?php
                                        $info_facultatif2 = DB::table('users as u')
                                                        ->join('profils as p','p.users_id','=','u.id')
                                                        ->join('type_profils as tp','tp.id','=','p.type_profils_id')
                                                        ->join('agents as a','a.id','=','u.agents_id')
                                                        ->join('agent_sections as ase','ase.agents_id','=','a.id')
                                                        ...
                                                        ->where('p.flag_actif',1)
                                                        ->whereRaw('st.code_structure = r.code_structure')
                                                        ->where('m.id', $search_magasin->id)
                                                        ->limit(1)
                                                        ->first();
                                        if ($info_facultatif2!=null) {
                                            $nom_prenoms = $info_facultatif2->mle.' - '.$info_facultatif2->nom_prenoms;
                                        }
                                        ?>
    
                                        <div class="col-md-4">
                                            <label for="profils_id">Responsable <sup style="color: red">*</sup></label>
                                            <input style="background-color: #e9ecef" onfocus="this.blur()" id="profils_id" type="text" class="form-control @error('profils_id') is-invalid @enderror" name="profils_id" value="{{ old('profils_id') ?? $nom_prenoms ?? '' }}">
