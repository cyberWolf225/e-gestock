...
<div class="container">
    ...
    <datalist id="design_fam">
        @foreach($familles as $famille)
        <option value="{{ $famille->design_fam }}">{{ $famille->design_fam }}</option>
        @endforeach
    </datalist>
    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="card">
                <div class="card-header entete-table">{{ __('Enregistrement de famille d\'article') }}</div>
                <div class="card-body">
                ...
                <table style="width: 100%">
                    ...
                    <div class="form-group row">  
                        ...
                        <div class="col-md-2">
                            ...
                            <input autocomplete="off" onkeyup="editFamille(this)" list="ref_fam" id="ref_fam" type="text" class="form-control @error('ref_fam') is-invalid @enderror" name="ref_fam" value="{{ old('ref_fam') }}"  autocomplete="ref_fam">
                        ...
                        <div class="col-md-6">
                            ...
                            <input list="design_fam" autocomplete="off" id="design_fam" type="text" class="form-control @error('design_fam') is-invalid @enderror" name="design_fam" value="{{ old('design_fam') }}"  autocomplete="design_fam">
