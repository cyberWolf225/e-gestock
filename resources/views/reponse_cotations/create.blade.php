...
<div class="container" style="color:black">
    ...
    <div class="row"> 
        <div class="col-md-12">
            ...
            <div class="card">
                <div class="card-header entete-table">{{ __( $buttons['titre'] ?? 'DEMANDE DE COTATION') }} 
                ...
                <div class="card-body">
                    ...
                    <form enctype="multipart/form-data" method="POST" action="{{ route('reponse_cotations.store') }}">
                        @csrf
                        ...
                        <div class="row d-flex">
                                ...
                                <div class="row d-flex" style="margin-top: -10px;">
                                    ...
                                    <div class="col-md-3 pr-1">
                                        <div class="form-group d-flex ">
                                            ...
                                            <input name="demande_cotations_id" id="demande_cotations_id" style="display:none" value="{{ $demande_cotation->id ?? '' }}">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="row d-flex" style="margin-top: -10px;">
                                    ...
                                    <div class="col-md-3 pr-1">
                                        <div class="form-group d-flex ">
                                            <input required onfocus="this.blur()" style="background-color: #e9ecef; display:none" value="{{ $organisation->id ?? '' }}" autocomplete="off" type="text" name="organisations_id" class="form-control">

                                            <input onfocus="this.blur()" style="background-color: #e9ecef" value="{{ $organisation->entnum ?? '' }}" autocomplete="off" type="text" name="entnum" class="form-control">
                                        </div>
                                    </div>
                                    <div class="col-md-6 pl-0">
                                        <div class="form-group d-flex ">
                                            <input required onfocus="this.blur()" style="background-color: #e9ecef" value="{{ $organisation->denomination ?? '' }}" autocomplete="off" type="text" name="denomination" class="form-control">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row d-flex" style="margin-top: -10px;">
                                    ...
                                    <div class="col-md-3 pr-1">
                                        <div class="form-group d-flex ">
                                            <input value="{{ old('code_devise') ?? $devise_default->code ?? '' }}" autocomplete="off" type="text" id="code_devise" name="code_devise" class="form-control" 
                                    ...
                                    <div class="col-md-6 pl-0">
                                        <div class="form-group d-flex ">
                                            <input value="{{ old('libelle_devise') ?? $devise_default->libelle ?? '' }}" onfocus="this.blur()" style="background-color: #e9ecef" autocomplete="off" type="text" id="libelle_devise" name="libelle_devise" class="form-control griser">
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="panel panel-footer">
                                @if(isset($demande_cotation->libelle))
                                    ...
                                    <div id="div_detail_bcs" style="@if($display_div_detail_bcs === null) display:none @endif">
                                        @include('reponse_cotations.partial_create_bcs')
                                    </div>
                                ...
                                @if(isset($demande_cotation->libelle))
                                    ...
                                    <div id="div_detail_bcn" style="@if($display_div_detail_bcn === null) display:none @endif">
                                        @include('reponse_cotations.partial_create_bcn')
                                    </div>
                                ...
                                @include('reponse_cotations.partial_create_footer')
                                    ...
                                    <table style="width: 100%">
                                        <tr>
                                            <td colspan="4" style="border-bottom: none">
                                                <span style="font-weight: bold">Dernier commentaire écrit par </span> 
                                                
                                                @if(isset($type_profils_name))
                                                @if($type_profils_name != 'Fournisseur')
                                                <span style="color: brown; margin-left:3px;"> {{ $statut_demande_cotation_demande->nom_prenoms ?? '' }} </span>&nbsp; (<span style="font-style: italic; color:grey"> {{ $statut_demande_cotation_demande->name ?? '' }} </span>)
                                                @endif
                                                @endif

                                                @if(isset($type_profils_name))
                                                @if($type_profils_name === 'Fournisseur')
                                                <span style="color: brown; margin-left:3px;"> SERVICE ACHATS/CNPS</span>
                                                @endif
                                                @endif
                                                <br>
                                                <br>
                                                <table width="100%" cellspacing="0" border="1" style="background-color:#d4edda; border-color:#155724; font-weight:bold">
                                                    <tr>
                                                        <td>
                                                            ...
                                                            </svg> &nbsp; {{ $statut_demande_cotation_demande->commentaire ?? '' }}
                                                        </td>
                                                    </tr>
                                                </table>
                                            </td>
                                            ...
                                            <td colspan="4" style="border: none; vertical-align:middle; text-align:right">
                                                <div class="row justify-content-center">
                                                    ...
                                                    <div class="col-md-7">
                                                        ...
                                                        <textarea @if(isset($griser_offre)) disabled style="width: 100%; resize:none" @else style="width: 100%; resize:none" @endif class="form-control @error('commentaire') is-invalid @enderror commentaire" name="commentaire" rows="2"  placeholder="Saisissez votre commentaire">{{ old('commentaire') ?? '' }}</textarea>
