        ...
        <td colspan="8" style="border: none">
            <div class="row d-flex pl-3">
                ...
                <div class="pl-1" style="text-align:center"><label class="label" class="font-weight-bold  mt-1 mr-1">Taux remise (%)</label><br>
                    ...
                    <input autocomplete="off" type="text" name="taux_remise_generale" class="form-control taux_remise_generale"
                    ...
                    @if($griser_offre === null)
                        oninput ="validateNumber(this);" onkeyup="editTauxRemiseGenerale(this)" style="width:90px; text-align:center;"
                    @endif
                ...
                <div class="pl-1" style="text-align:center"><label class="label" class="  mt-1 mr-1">Remise</label><br>  
                    ...
                    <input autocomplete="off" type="text" name="remise_generale" class="form-control remise_generale"
                    ...
                    @if($griser_offre === null)
                    onkeyup="editRemiseGenerale(this)" oninput="validateNumber(this);" style="width:110px; text-align:right;"
                    @endif
                ...
                <div class="pl-1" style="text-align:center"><label class="label" class=" mt-1 mr-2">TVA (%)</label><br>  
                    ...
                    <input autocomplete="off" type="text" name="tva" class="form-control tva"
                    value="{{ $reponse_cotation->tva ?? '' }}"
                    ...
                    @if($griser_offre === null)
                    list="list_taxe_tva" onkeyup="editRemiseGenerale(this)" oninput="validateNumber(this);" style="width:80px; text-align:center"
                    @endif
            ...
            <div class="row d-flex pl-3">
                ...
                <div style="padding-left:3px; text-align:center" ><label class="label" class=" mt-1 mr-2">Acompte</label><br>
                    ...
                    @if(isset($demande_cotation->taux_acompte) && isset($reponse_cotation->acompte))

                    @if($demande_cotation->taux_acompte != null && $reponse_cotation->acompte === 1)
                        checked
