...
<div class="container" style="color:black">
    ...
    <div class="row"> 
        <div class="col-md-12">
            ...
            <div class="card">
                <div class="card-header entete-table">{{ __( $buttons['titre'] ?? 'MODIFIER LA COTATION') }} 
                            ...
                            <div class="panel panel-footer">
                                @if(isset($demande_cotation->libelle))
                                    ...
                                    <div id="div_detail_bcs" style="@if($display_div_detail_bcs === null) display:none @endif">
                                        @include('reponse_cotations.partial_edit_bcs')
                                    </div>
                                ...
                                @if(isset($demande_cotation->libelle))
                                    ...
                                    <div id="div_detail_bcn" style="@if($display_div_detail_bcn === null) display:none @endif">
                                        @include('reponse_cotations.partial_edit_bcn')
                                    </div>
                                ...
                                @include('reponse_cotations.partial_edit_footer')
                                    ...
                                    <table style="width: 100%">
                                        <tr>
                                            <td colspan="4" style="border-bottom: none">
                                                <span style="font-weight: bold">Dernier commentaire écrit par </span> <span style="color: brown; margin-left:3px;"> {{ $nom_prenoms_commentaire ?? $statut_demande_cotation->nom_prenoms ?? '' }} </span>&nbsp; (<span style="font-style: italic; color:grey"> {{ $profil_commentaire ?? $statut_demande_cotation->name ?? '' }} </span>)
