...
<div class="container">
    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                <div class="card-header entete-table">{{ __('ENREGISTREMENT DE FOURNISSEUR') }}</div>
                            ...
                            <div class="col-md-12">
                                <div class="form-group row">
                                    <div class="col-md-2">
                                        ...
                                        <input onkeyup="editMle(this)" onblur="getEntreprise()" onkeypress="validate(event)" id="entnum" type="text" class="form-control input-valide @error('entnum') is-invalid @enderror" name="entnum" value="{{ old('entnum') ?? $organisation['entnum'] ?? '' }}"  autocomplete="off">
                                    ...
                                    <div class="col-md-5">
                                        ...
                                        <input id="denomination" type="text" class="form-control input-valide @error('denomination') is-invalid @enderror" name="denomination" value="{{ old('denomination') ?? $organisation['entraisoc'] ?? '' }}"  autocomplete="off">
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <input  id="email" type="email" class="form-control input-valide @error('email') is-invalid @enderror" name="email" value="{{ old('email') ?? $organisation['ent_email_1'] ?? '' }}"  autocomplete="off">
                                    ...
                                    <?php 
                                        ...
                                        if(isset($organisation['tel_portable'])) {
                                            $contacts = $organisation['tel_portable'];
                                        }

                                        if(isset($organisation['entteleph'])){
                                            if (isset($contacts)) {
                                                $contacts = $contacts.' / '.$organisation['entteleph'];
                                            }else{
                                                $contacts = $organisation['entteleph'];
                                            }
                                    ...
                                    <div class="col-md-2">
                                        ...
                                        <input id="contacts" type="text" class="form-control input-valide @error('contacts') is-invalid @enderror" name="contacts" value="{{ old('contacts') ?? $contacts ?? '' }}"  autocomplete="off">
                                ...
                                <?php
                                    $mle = null;
                                    if (isset($organisation['entnum'])) {
                                        $mle = 'frs'.$organisation['entnum'];
                                    }
                                ?>
                                ...
                                <div class="form-group row">
                                    <div class="col-md-2">
                                        ...
                                        <input onfocus="this.blur()" style="background-color: #e9ecef;" id="mle" type="text" class="form-control input-valide @error('mle') is-invalid @enderror" name="mle" value="{{ old('mle') ?? $mle ?? $mle_non_immatricule ?? '' }}"  autocomplete="off" autofocus>

                                        <input onfocus="this.blur()" style="background-color: #e9ecef; display:none" id="num_fournisseur" type="text" class="form-control input-valide @error('num_fournisseur') is-invalid @enderror" name="num_fournisseur" value="{{ old('num_fournisseur') ?? $num_fournisseur ?? '' }}"  autocomplete="off" autofocus>
                                    ...
                                    <div class="col-md-5">
                                        ...
                                        <input  id="nom_prenoms" type="text" class="form-control input-valide @error('nom_prenoms') is-invalid @enderror" name="nom_prenoms" value="{{ old('nom_prenoms') ?? $organisation['entsigle'] ?? $organisation['entraisoc'] ?? '' }}"  autocomplete="off" autofocus>
                                ...
                                <div class="form-group row">
                                    <div class="col-md-2">
                                        ...
                                        <input id="num_contribuable" type="text" class="form-control input-valide @error('num_contribuable') is-invalid @enderror" name="num_contribuable" value="{{ old('num_contribuable') ?? $organisation['entcptcont'] ?? '' }}"  autocomplete="off" >
                                    ...
                                    <div class="col-md-5">
                                        ...
                                        <input  id="adresse" type="text" class="form-control input-valide @error('adresse') is-invalid @enderror" name="adresse" value="{{ old('adresse') ?? $organisation['entadresphy'] ?? '' }}"  autocomplete="off" >
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <input id="statut" type="checkbox" name="statut" autocomplete="off" checked>
                                    </div>
                                    <div class="col-md-2">
                                ...
                                <div class="form-group row">
                                    <div class="col-md-6">
                                        <label class="label" for="depot">Dépôt d'article &nbsp; <a title="Rattacher un nouveau dépôt" onclick="myCreateFunction2()" href="#"><svg style="color: green; margin-top:-3px; cursor:pointer" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-plus" viewBox="0 0 16 16">
                                            ...
                                            <input style="margin-left: 10px;" id="all_depot" type="checkbox" name="all_depot" autocomplete="off">
                                        </label>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input style="margin-left: 10px;" id="all_famille" type="checkbox" name="all_famille" autocomplete="off">
                                        </label>
...
<script>
    ...
    editMle = function(a){
        ...
        if(saisie != ''){
            var mle = 'frs' + saisie ;
            // var mle = saisie +''+ num_fournisseur;
    ...
    function getEntreprise() {
        ...
        if (valeur != '') {
            ...
            document.location.replace('/organisations/creates/'+entnum);
        }
