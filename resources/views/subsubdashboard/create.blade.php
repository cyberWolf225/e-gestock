...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">{{ __('Ajouter un sous-menu de niveau 2') }}</div>
                ...
                <div class="card-body">
                    ...
                    @endif
                    <form method="POST" action="{{ route('subsubdashboard.store') }}">
                        <datalist id="sub_dashboard">
                            @foreach($sub_dashboards as $sub_dashboard)
                            <?php 
                            
                            $sub_sub_dashboards = DB::select("SELECT * FROM sub_sub_dashboards WHERE sub_dashboards_id = '".$sub_dashboard->id."' ORDER BY position DESC LIMIT 1");
                                
                                if ($sub_sub_dashboards != null) {
                                    foreach ($sub_sub_dashboards as $sub_sub_dashboard) {
                                       $position = $sub_sub_dashboard->position + 1;
                                    }
                                }else{
                                    $position = 1;
                                }
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input onkeyup="editPosition(this)" list="sub_dashboard" id="sub_dashboard_name" type="text" class="form-control @error('sub_dashboard_name') is-invalid @enderror" name="sub_dashboard_name" value="{{ old('sub_dashboard_name') }}" autocomplete="sub_dashboard_name" autofocus>
