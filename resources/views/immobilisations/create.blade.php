...
<div class="container" style="font-size: 10px; line-height:10px">
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                <div class="card-header entete-table">{{ __('EXPRESSION DU BESOIN D\'EQUIPEMENT') }} 
                    <span style="float: right; margin-right: 20px;">DATE : <strong>{{ date("d/m/Y") }}</strong></span>
                    <span style="float: right; margin-right: 20px;">EXERCICE : <strong>{{ date("Y") }}</strong></span>
                ...
                <div class="card-body">
                    ...
                    @endif
                    <form enctype="multipart/form-data" method="POST" action="{{ route('immobilisations.store') }}">
                        @csrf
                        <div class="row">
                            <div class="col-md-9"> 
                                <div class="form-group">
                                    <label class="label">Intitulé de la demande <span style="color: red"><sup> *</sup></span></label>
                                    <input autofocus autocomplete="off" title="Entrez l'intitulé de votre demande"  type="text" name="intitule" class="form-control @error('intitule') is-invalid @enderror" required placeholder="Saisissez l'intitulé de votre demande" style="font-size: 10px;" value="{{ old('intitule') ?? $intitule_default ?? '' }}">
                                    @error('intitule')
                            ...
                            <table class="table table-bordered table-striped" id="myTable" style="width:100%; border-collapse: collapse; padding: 0; margin: 0;">
                                <thead>
                                    <tr style="background-color: #e9ecef; color: #7d7e8f">
                                        <th style="width:7%; text-align:center">BENEFICIAIRE<span style="color: red"><sup> *</sup></span></th>
                                        <th style="width:20%; text-align:left">DESCRIPTION DU BENEFICIAIRE</th>
                                        <th style="width:7%; text-align:left">RÉF. ÉQUIPEMENT<span style="color: red"><sup> *</sup></span></th>
                                        ...
                                        <th style="width:7%; text-align:center">QTÉ<span style="color: red"><sup> *</sup></span></th>
                                        <th style="width:13%; text-align:center; display:none">COÛT</th>
                                        <th style="width:1%; text-align:center">ÉCHANTILLON</th>
                                        
                                        <th style="text-align:center; width:1%"><a title="Ajouter un nouvel article à votre demande" onclick="myCreateFunction()" href="#" class="addRow"><svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-plus" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <tbody>
                                    <tr style="border-collapse: collapse; padding: 0; margin: 0;">
                                        <td style="border-collapse: collapse; padding: 0; margin: 0; background-color:white">
                                            <input autocomplete="off" title="Saisissez le matricule ou le nom du bénéficiare" required list="list_agent" type="text" onkeyup="editAgent(this)" id="beneficiaire" name="beneficiaire[]" class="form-control beneficiaire" style="font-size:10px; text-align:center; border:none">
                                        </td>

                                        <td style="border-collapse: collapse; padding: 0; margin: 0;">
                                            <input autocomplete="off" title="Nom & Prénoms du bénéficiaire" required onfocus="this.blur()" style="background-color: transparent; border-color: transparent; font-size:10px; " type="text" id="description_beneficiaire" name="description_beneficiaire[]" class="form-control description_beneficiaire">

                                            <input autocomplete="off" required onfocus="this.blur()" style="background-color: transparent; border-color: transparent; font-size:10px; display:none" type="text" id="type_beneficiaire" name="type_beneficiaire[]" class="form-control type_beneficiaire">
                                        </td>

                                        <td style="border-collapse: collapse; padding: 0; margin: 0 ; background-color:white">
                                            <input autocomplete="off" title="sélectionnez l'article en saisissant soit la référence ou la désignation" required list="list_article" type="text" onkeyup="editDesign(this)" id="ref_articles" name="ref_articles[]" class="form-control ref_articles" style="font-size:10px; text-align:left; border:none">
                                            <input autocomplete="off" style="display: none; font-size:10px;" required type="text" id="magasin_stocks_id" name="magasin_stocks_id[]" class="form-control magasin_stocks_id">
                                        </td>
                                        <td style="border-collapse: collapse; padding: 0; margin: 0;">
                                            <input autocomplete="off" title="Désignation de l'article sélectionné" required onfocus="this.blur()" style="background-color: transparent; border-color: transparent; font-size:10px; " type="text" onkeyup="editMontant(this)" id="design_article" name="design_article[]" class="form-control design_article">
                                        </td>
                                        ...
                                        <td style="border-collapse: collapse; padding: 0; margin: 0; background-color:white;">
                                            ...
                                            <input autocomplete="off" title="Entrez la quantité d'article souhaitée" required type="text" onkeyup="editMontant(this)" onkeypress="validate(event)" style="text-align:center; font-size:10px; border:none" name="qte[]" class="form-control qte">
                            ...
                            <table style="width: 100%; margin-top:10px;">
                                <tr>
                                    <td style="border:  ; vertical-align:middle; width:90%">
                                        ...
                                        <textarea class="form-control" name="commentaire" rows="2" style="width: 100%;" placeholder="Saisissez un commentaire"></textarea>
                                    
                                    </td>

                                    <td  style="border:  ; vertical-align:middle; width:10%">
                                    
                                        <button onclick="return confirm('Faut-il la demande d\'équipements ?')" title="Enregistrer votre demande"  type="submit" class="btn btn-success" style="font-size:10px; margin-top:1px; vertical-align:middle">
                                        Enregistrer
                                        </button>
