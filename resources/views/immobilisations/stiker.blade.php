                            ...
                            <table class="table table-bordered table-striped" id="myTable" style="width:100%; border-collapse: collapse; padding: 0; margin: 0;">
                                <thead>
                                    <tr style="background-color: #e9ecef; color: #7d7e8f; vertical-align:middle">
                                        ...
                                        <th style="vertical-align:middle; width:1%; text-align:center; white-space: nowrap;">N°</th>
                                        <th style="; vertical-align:middle; width:20%; text-align:left">BENEFICIAIRE</th>
                                        <th style="vertical-align:middle; width:1%; text-align:center; white-space: nowrap;">MLE / <br/>CODE <br/>STRUCTURE @if($verrou_saisie === null)<span style="; vertical-align:middle; color: red"><sup> *</sup></span> @endif </th>
                                        <th style="; vertical-align:middle; width:1%; text-align:left; white-space: nowrap; display:none">RÉF. ÉQUIPEMENT @if($verrou_saisie === null)<span style="; vertical-align:middle; color: red"><sup> *</sup></span> @endif </th>
                                        <th style="; vertical-align:middle; width:20%; text-align:left">DÉSIGNATION</th>
                                        <th style="; vertical-align:middle; width:10%; text-align:center; display:none; text-align:center">PRIX U</th>
                                        <th style="; vertical-align:middle; width:7%; text-align:center; display:none">QTÉ @if($verrou_saisie === null)<span style="; vertical-align:middle; color: red"><sup> *</sup></span> @endif </th>
                                        @if(isset($champ_qte_sortie))
                                            @if($champ_qte_sortie === 1)
                                            <th style="; vertical-align:middle; width:7%; text-align:center ; display:none">QTÉ SORTIE </th>
                                            <th style="; vertical-align:middle; width:7%; text-align:center ; display:none">QTÉ RESTANT À SORTIR @if($champ_qte_sortie_actif === 1)<span style="; vertical-align:middle; color: red"><sup> *</sup></span> @endif </th>
                                            @endif
                                        @endif

                                        <th style="; vertical-align:middle; width:13%; text-align:center; display:none">COÛT</th>
                                        <th style="; vertical-align:middle; width:1%; text-align:center; display:none">ÉCHANTILLON</th>
                                        @if(isset($champ_observation))
                                            @if($champ_observation === 1)
                                            <th style="; vertical-align:middle; width:20%; text-align:center; display:none">OBSERVATIONS</th>
                                            @endif
                                        @endif

                                        <th style="; vertical-align:middle; width:13%; text-align:center;">N° STICKER</th>

                                        <th style="; vertical-align:middle; width:13%; text-align:center;">N° DE SERIE</th>

                                        <th style="; vertical-align:middle; width:13%; text-align:center;">TYPE</th>
                                        <th style="; vertical-align:middle; width:13%; text-align:center;width:1%;white-space: nowrap;"></th>
                                        <th style="display:none; vertical-align:middle; width:13%; text-align:center;width:1%;white-space: nowrap;"></th>
                                ...
                                <tbody>
                                    ...
                                    @foreach($immobilisations as $immobilisat)
                                        ...
                                        @for($u = 0; $u < $immobilisat->qte_sortie; $u++)
                                            ...
                                            <?php 
                                                ...
                                                $ref_equipement = null;
                                                $affectations_index = null;
                                                $flag_actif = null;
                                                $type_affectations_libelle = null;

                                                $grise_ligne = null;


                                                $affectation = DB::table('affectations as a')
                                                ->join('equipement_immobilisers as ei','ei.ref_equipement','=','a.ref_equipement')
                                                ->join('type_affectations as ta','ta.id','=','a.type_affectations_id')
                                                ->join('detail_immobilisations as di','di.id','=','a.detail_immobilisations_id')
                                                ->join('immobilisations as i','i.id','=','di.immobilisations_id')
                                                ->where('a.index',$index)
                                                ->where('a.detail_immobilisations_id',$immobilisat->detail_immobilisations_id)
                                                ->where('i.id',$immobilisat->id)
                                                ->select('a.ref_equipement','a.index','a.detail_immobilisations_id','a.type_affectations_id','a.date_debut','a.date_fin','a.flag_actif','ta.libelle as type_affectations_libelle')
                                                ->first();

                                                if ($affectation != null) {

                                                    $ref_equipement = $affectation->ref_equipement;
                                                    $affectations_index = $affectation->index;
                                                    $flag_actif = $affectation->flag_actif;
                                                    $type_affectations_libelle = $affectation->type_affectations_libelle;

                                                    $grise_ligne = 1;

                                                    $option_equipement = DB::table('option_equipements as oe')
                                                    ->join('options as o','o.id','=','oe.options_id')
                                                    ->where('oe.ref_equipement',$affectation->ref_equipement)
                                                    ->where('o.libelle','N° Sticker')
                                                    ->select('oe.valeur_option')
                                                    ->first();

                                                    if ($option_equipement != null) {
                                                        $num_sticker = $option_equipement->valeur_option;
                                                    }

                                                    $option_equipement = DB::table('option_equipements as oe')
                                                    ->join('options as o','o.id','=','oe.options_id')
                                                    ->where('oe.ref_equipement',$affectation->ref_equipement)
                                                    ->where('o.libelle','N° Serie')
                                                    ->select('oe.valeur_option')
                                                    ->first();

                                                    if ($option_equipement != null) {
                                                        $num_serie = $option_equipement->valeur_option;
                                                    }
                                        ...
                                        <tr style="border-collapse: collapse; padding: 0; margin: 0; @if($view_equipement_immobilise === 1) @if($ref_equipement === null) display:none @endif  @endif ">
                                            ...
                                            <td style="border-collapse: collapse; padding: 0; margin: 0;">
                                                <input class="form-control" value="{{ $ref_equipement ?? '' }}" name="ref_equipement[]" onfocus="this.blur()" style="display: none">
                                            ...
                                            @if(isset($champ_qte_sortie))
                                                @if($champ_qte_sortie === 1)
                                                    ...
                                                    <td style="border-collapse: collapse; padding: 0; margin: 0; background-color:transparent; display:none;">
                                                    ...
                                                    <td style="border-collapse: collapse; padding: 0; margin: 0; display:none; @if($champ_qte_sortie_actif === 1) background-color:white @else background-color:transparent @endif @if($sortie_totale === 1) background-color:transparent @endif ">
                                            ...
                                            @if(isset($champ_observation))
                                                @if($champ_observation === 1)
                                                <td style="border-collapse: collapse; padding: 0; margin: 0; display:none;">
                                                    <textarea 
                                            ...
                                            <td style="border-collapse: collapse; padding: 0; margin: 0;">
                                                {{-- @if(isset($num_sticker)) onfocus="this.blur()" @endif --}}

                                                {{-- @if(isset($num_sticker)) background-color:transparent @endif --}}
                                                <textarea style="resize: none; height:35px; border:none; @if ($verrou_saisie === 1) background-color:transparent; @endif " class="form-control" rows="1" name="stiker[]" 
                                                
                                                @if ($verrou_saisie === 1) 
                                                    onfocus="this.blur()"
                                                @endif
                                                
                                                >{{ $num_sticker ?? '' }}</textarea>
                                            </td>
                                            <td style="border-collapse: collapse; padding: 0; margin: 0;">
                                                {{-- @if(isset($num_serie)) onfocus="this.blur()" @endif --}}

                                                {{-- @if(isset($num_serie)) background-color:transparent @endif --}}

                                                <textarea style="resize: none; height:35px; border:none; @if ($verrou_saisie === 1) background-color:transparent; @endif " class="form-control" rows="1" name="serie[]" 
                                            ...
                                            <td style="border-collapse: collapse; padding: 0; margin: 0;">
                                                ...
                                                <select class="form-control form-control-sm" name="type_affectations_libelle[]" style="height:35px; border:none; @if ($verrou_saisie === 1) background-color:transparent; @endif " 
                                                ...
                                                > 
                                                    ...
                                                    <option 
                                                    @if(isset($type_affectations_libelle)) @if($type_affectations_libelle === 'ATTRIBUTION') selected @endif @endif  
                                                    value="ATTRIBUTION">ATTRIBUTION</option>
                                                    <option @if(isset($type_affectations_libelle)) @if($type_affectations_libelle === 'RÉATTRIBUTION') selected @endif @endif value="RÉATTRIBUTION">RÉATTRIBUTION</option>
                                                    <option @if(isset($type_affectations_libelle)) @if($type_affectations_libelle === 'PRÊT') selected @endif @endif value="PRÊT">PRÊT</option>
                                                    <option></option>

                                                </select>
                                                
                                            </td>
                                            <td style="border-collapse: collapse; padding: 0; margin: 0; vertical-align:middle; text-align:center">

                                                @if(isset($ref_equipement))

                                                    @if($flag_actif === 1)

                                                        <svg style="color: #39db70" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-check-circle-fill" viewBox="0 0 16 16">
                                                        <path d="M16 8A8 8 0 1 1 0 8a8 8 0 0 1 16 0zm-3.97-3.03a.75.75 0 0 0-1.08.022L7.477 9.417 5.384 7.323a.75.75 0 0 0-1.06 1.06L6.97 11.03a.75.75 0 0 0 1.079-.02l3.992-4.99a.75.75 0 0 0-.01-1.05z"/>
                                                        </svg>

                                                        <input checked style="display: none" type="checkbox" name="affectation[]" value="{{ $i-1 ?? '' }}">

                                                    @elseif($flag_actif === 0)

                                                        <svg style="color: #721c24" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-x-circle-fill" viewBox="0 0 16 16">
                                                        <path d="M16 8A8 8 0 1 1 0 8a8 8 0 0 1 16 0zM5.354 4.646a.5.5 0 1 0-.708.708L7.293 8l-2.647 2.646a.5.5 0 0 0 .708.708L8 8.707l2.646 2.647a.5.5 0 0 0 .708-.708L8.707 8l2.647-2.646a.5.5 0 0 0-.708-.708L8 7.293 5.354 4.646z"/>
                                                        </svg>

                                                        <input style="display: none" type="checkbox" name="affectation[]" value="{{ $i-1 ?? '' }}">
                                                ...
                                                @else
                                                    <input type="checkbox" name="affectation[]" value="{{ $i-1 ?? '' }}">
                                                @endif
                                                
                                            </td>

                                            <td style="border-collapse: collapse; padding: 0; margin: 0; vertical-align:middle; text-align:center; display:none">
                                                <input value="{{ $index ?? '' }}" type="text" name="index[]" class="form-control" style="display: none">
                                            </td>
                                            

                                        </tr>
                                        <?php if($view_equipement_immobilise === 1){ if($ref_equipement === null){ }else{ $i++; } }else{ $i++; }  ?>
                                        @endfor
