...
<div class="container">
    <div class="row mt-5">
        <div class="col-12">
            <label><strong>Detail du menu</strong></label>
            <ul><li>{{ $dashboard->name }} : <a href="#">{{ $dashboard->link }}</a>
                    <ul>
                        <?php $subdashboards = DB::select("SELECT * FROM sub_dashboards 
                                                           WHERE dashboards_id = '".$dashboard->id."' "); 
                        ?>
                        @foreach($subdashboards as $subdashboard)
  ...
  <path fill-rule="evenodd" d="M1.5 1.5A.5.5 0 0 0 1 2v4.8a2.5 2.5 0 0 0 2.5 2.5h9.793l-3.347 3.346a.5.5 0 0 0 .708.708l4.2-4.2a.5.5 0 0 0 0-.708l-4-4a.5.5 0 0 0-.708.708L13.293 8.3H3.5A1.5 1.5 0 0 1 2 6.8V2a.5.5 0 0 0-.5-.5z"/>
                            ...
                            <ul>
                                <?php $subsubdashboards = DB::select("SELECT * FROM sub_sub_dashboards 
                                                                WHERE sub_dashboards_id = '".$subdashboard->id."' "); 
                                ?>
                                @foreach($subsubdashboards as $subsubdashboard)
