...
<div class="wrapper">
            ...
            <a href="/session/set/{{ $type_profil->profils_id ?? '' }}" class="dropdown-item">
              ...
              <div class="media">
                ...
                <div class="media-body">
                  <p class="text-sm">{{ $type_profil->name ?? '' }}</p>
                </div>
              </div>
              <!-- Message End -->
            </a>
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4" style="background-color: #fff; color:black">
    <!-- Brand Logo -->
      ...
      <nav class="mt-2">
        ...
        @if (Session::has('profils_id'))
          ...
          @foreach($dashboards as $dashboard)
              ...
              <li class="nav-item">
                <a href="#" class="nav-link ancre-style" style="color:#fff">
