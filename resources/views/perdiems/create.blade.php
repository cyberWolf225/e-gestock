...
<div class="container">
    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                <div class="card-header entete-table">{{ __(strtoupper('Enregistrement de perdiems')) }}
                    <span style="float: right; margin-right: 20px;">DATE : <strong>{{ date("d/m/Y") }}</strong></span>
                    <span style="float: right; margin-right: 20px;">EXERCICE : <strong>{{ $exercices->exercice ?? date("Y") }}</strong></span>
                ...
                <div class="card-body"> 
                    ...
                    <form enctype="multipart/form-data" method="POST" action="{{ route('perdiems.store') }}">
                        @csrf  
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="row d-flex" style="margin-top: -10px;">
                                    ...
                                    <div class="col-md-3 pr-1">
                                        <div class="form-group d-flex ">
                                            ...
                                            <input required onkeyup="editStructure(this)" list="structure" autocomplete="off" type="text" name="code_structure" id="code_structure" class="form-control @error('code_structure') is-invalid @enderror code_structure" value="{{ old('code_structure') ?? $structure_perdiem->code_structure ?? '' }}">
                                        </div>
                                    ...
                                    <div class="col-md-6 pl-0">
                                        <div class="form-group d-flex ">
                                            <input required onfocus="this.blur()" style="background-color: #e9ecef" autocomplete="off" type="text" name="nom_structure" id="nom_structure" class="form-control griser @error('nom_structure') is-invalid @enderror nom_structure" value="{{ old('nom_structure') ?? $structure_perdiem->nom_structure ?? '' }}">
                                        </div>
                                        @error('nom_structure')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                ...
                                <div class="row d-flex" style="margin-top: -10px;">
                                    ...
                                    <div class="col-md-3 pr-1">
                                        <div class="form-group d-flex ">
                                            <input required  onkeyup="editGestion(this)" list="gestion" autocomplete="off" type="text" name="code_gestion" id="code_gestion" class="form-control @error('code_gestion') is-invalid @enderror code_gestion" value="{{ old('code_gestion') ?? $gestion_perdiem->code_gestion ?? '' }}">
                                        </div>
                                        @error('code_gestion')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                    ...
                                    <div class="col-md-6 pl-0">
                                        <div class="form-group d-flex ">
                                            <input required onfocus="this.blur()" autocomplete="off" type="text" name="libelle_gestion" id="libelle_gestion" class="form-control @error('libelle_gestion') is-invalid @enderror libelle_gestion" style="background-color: #e9ecef" value="{{ old('libelle_gestion') ?? $gestion_perdiem->libelle_gestion ?? '' }}">
                                        </div>
                            ...
                            <div class="col-md-6">
                                <div class="row d-flex" style="margin-top: -10px;">
                                    <div class="col-sm-3">
                                        <div class="form-group" style="text-align: right;  display:none">
                                            <label class="mt-1 label">N° Oracle <sup style="color: red">*</sup></label> 
                                        </div>
                                    ...
                                    <div class="col-md-3 pr-1">
                                        <div class="form-group d-flex ">
                                            ...
                                            <input onfocus="this.blur()" style="background-color: #e9ecef;color:red; font-weight:bold; margin-top:-7px; display:none" id="num_or" type="text" class="form-control @error('num_or') is-invalid @enderror" name="num_or" value="{{ $num_bc ?? null }}"  autocomplete="off" >
                                ...
                                <div class="row d-flex" style="margin-top: -10px;">
                                    <div class="col-sm-3">
                                        <div class="form-group" style="text-align: right">
                                            <label class="mt-1 label">Intitulé <sup style="color: red">*</sup></label> 
                                        </div>
                                    ...
                                    <div class="col-md-9 pr-1">
                                        <div class="form-group d-flex ">
                                            ...
                                            <textarea rows="3" id="perdiems_intitule" type="text" class="form-control @error('perdiems_intitule') is-invalid @enderror" name="perdiems_intitule" @if(!isset($structure_perdiem)) onfocus="this.blur()" style="background-color: #e9ecef; resize:none" @else style="resize:none" @endif >{{ old('perdiems_intitule') ?? '' }}</textarea>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <table class="table" id="myTable" style="width:100%; border-collapse: collapse; padding: 0; margin: 0;">
                                    ...
                                    <thead>
                                        <tr style=" background-color:#aabcc6; text-align: center; color:#033d88; text-shadow: 2px 5px 5px white ;">
                                            ...
                                            <th style="text-align:center; width:1%; color:white"><a title="Ajouter un nouvel article à votre demande" onclick="myCreateFunction()" href="#" class="addRow"><svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-plus" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td style="text-align: center; vertical-align:middle; white-space:nowrap; width:1px; padding: 0; margin: 0;">1</td>
                                            <td style="text-align: center; vertical-align:middle; padding: 0; margin: 0;"><input list="agent" required class="form-control form-control-sm" name="nom_prenoms[]" autocomplete="off">
                                            </td>
                                            <td style="text-align: center; vertical-align:middle; padding: 0; margin: 0;"><input required class="form-control form-control-sm montant" name="montant[]" autocomplete="off" onkeypress="validate(event)" style="text-align:right" onkeyup="editMontant(this)"><input required class="form-control form-control-sm montant_bis" name="montant_bis[]" onkeypress="validate(event)" style="text-align:right; display:none"></td>
                                            <td style="text-align: center; vertical-align:middle; padding: 0; margin: 0;"><input style="height: 30px;" type="file" name="piece_identite[]"></td>
                                    ...
                                    <tfoot>
                                        <tr style="background-color:#aabcc6">
                                            ...
                                            <td style="text-align: center; vertical-align:middle; padding: 0; margin: 0;"><input onfocus="this.blur()" required class="form-control form-control-sm montant_total" name="montant_total" id="montant_total" style="text-align:right; border:none; color:#155724; font-weight:bold"></td>
...
<script>
        ...
        editStructure = function(a){
            ...
            if (nom_structure === undefined) {
                ...
                if (ref_fam != '') {
                    if (code_gestion != '') {
                        if (code_structure != '') {
                            document.location.replace('/perdiems/crypt/'+ref_fam+'/'+code_structure+'/'+code_gestion);
                        }
                    }
                }
        ...
        function myCreateFunction() {
            ...
            cell2.innerHTML = '<td style="border-collapse: collapse; padding: 0; margin: 0;"><input list="agent" required class="form-control form-control-sm" name="nom_prenoms[]" autocomplete="off"></td>';
