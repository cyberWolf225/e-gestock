...
class CreateStatutReponseCotationsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('statut_reponse_cotations', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('statut_reponse_cotations');
    }
}
