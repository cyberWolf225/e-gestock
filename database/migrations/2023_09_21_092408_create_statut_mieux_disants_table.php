...
class CreateStatutMieuxDisantsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('statut_mieux_disants', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('statut_mieux_disants');
    }
}
