...
class CreatePieceJointeLivraisonsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('piece_jointe_livraisons', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('piece_jointe_livraisons');
    }
}
