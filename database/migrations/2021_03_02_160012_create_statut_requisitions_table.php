...
class CreateStatutRequisitionsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('statut_requisitions', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('statut_requisitions');
    }
}
